...
class NBeats:  # UNIVARIATE DATA TO BE PASSED AS NUMPY ARRAY
    def __init__(self, period_to_forecast, data=None, backcast_length=None, save_checkpoint=False, path='',
                 checkpoint_file_name='nbeats-training-checkpoint.th', mode='cpu', batch_size=None, thetas_dims=[7, 8],
